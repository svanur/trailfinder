...
VALUES
    ...
    (gen_random_uuid(), 'Hvítasunnuhlaup Hauka 22km', 'hvitasunnuhlaup-hauka-22', '22km keppnisleiðin í Hvítasunnuhlaupi Hauka', 0, 0, 'unknown', 'out-and-back', 'hilly', 'trail', 'https://www.strava.com/activities/1586469545', false, seed_user_id),
    (gen_random_uuid(), 'Hvítasunnuhlaup Hauka 17km', 'hvitasunnuhlaup-hauka-17', '17km keppnisleiðin í Hvítasunnuhlaupi Hauka', 0, 0, 'moderate', 'unknown', 'hilly', 'trail', 'https://connect.garmin.com/modern/course/60180539', false, seed_user_id),
    ...
    (gen_random_uuid(), '5km hlaup HHFH og 66°N', 'hlaupaseria-66', 'Hlaupasería 66°N og Hlaupahóps FH', 5, 44, 'easy', 'out-and-back', 'flat', 'asphalt', '', false, seed_user_id),
    (gen_random_uuid(), 'Sandhlaupið', 'sandhlaupid', 'hlaupið í sandi', 11, 0, 'easy', 'unknown', 'flat', 'sand', '', false, seed_user_id),
    (gen_random_uuid(), 'Snjóhlaupið', 'snjohlaupid', 'hlaupið í snjó', 22, 0, 'moderate', 'unknown', 'flat', 'snow', '', false, seed_user_id),
    (gen_random_uuid(), 'Íshlaupið', 'islaupid', 'hlaupið á jökli', 33, 0, 'hard', 'out-and-back', 'flat', 'ice', '', false, seed_user_id),
